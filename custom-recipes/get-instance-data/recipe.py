# Code for custom code recipe get-instance-data
#
# This recipe has no inputRoles: it doesn't act on a user-supplied dataset,
# it queries the whole DSS instance through dataiku.api_client(). Only the
# output side of the input/output-role pattern applies here, via
# get_output_names_for_role("main_output").
# -*- coding: utf-8 -*-
import dataiku
